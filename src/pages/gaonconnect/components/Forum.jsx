    ...
    <div className="sg-forum-content-shell">
      ...
      <div className="sg-forum-topbar">
        ...
        <div className="sg-forum-total-card">
          ...
          <div className="sg-forum-total-icon">
            💬
          </div>

          <div>

            <p className="sg-forum-total-label">
              Total Posts
            </p>

            <h3 className="sg-forum-total-value">
            {totalPosts}
            </h3>
          ...
          >
                ...
                <div className="sg-forum-media-section">
                  ...
                  0 ? (
                    ...
                    <div className="sg-forum-no-media">
                      No Media
                    </div>
